...
public class TransactionsReport extends JFrame {
	...
	public TransactionsReport() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TransactionsReport.class.getResource("/Resources/Custo.Man.Christmas.Folder.Library.ico.png")));
		...
		JLabel lblLibraryMnagementSystem = new JLabel("Transactions Report");
		...
		label.setIcon(new ImageIcon(TransactionsReport.class.getResource("/Resources/Bino.png")));
